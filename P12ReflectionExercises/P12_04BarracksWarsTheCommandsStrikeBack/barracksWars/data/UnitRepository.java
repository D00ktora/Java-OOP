package P12ReflectionExercises.P12_04BarracksWarsTheCommandsStrikeBack.barracksWars.data;
...
public class UnitRepository implements Repository {
	...
	public void removeUnit(String unitType){
		if (amountOfUnits.containsKey(unitType) && amountOfUnits.get(unitType) >= 1) {
			int currentUnitAmount = amountOfUnits.get(unitType);
			amountOfUnits.put(unitType,currentUnitAmount - 1);
		} else {
